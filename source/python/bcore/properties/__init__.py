...
which in turn return instance of type [PropertyBase](@ref bcore.properties.base.PropertyBase). The latter
...
+ **Components Summary**
 - **Descriptors**
  - \ref bcore.properties.base.PropertyDescriptor "PropertyDescriptor"
   - A basic property with meta-data support
  - \ref bcore.properties.base.CompoundPropertyDescriptor "CompoundPropertyDescriptor"
   - A Descriptor that can contain other descriptors, useful for nesting of properties
 - **Properties**
  + \ref bcore.properties.base.PropertyBase "PropertyBase"
...
In the first example, a \ref bcore.properties.types.PrefixProperty "PrefixProperty" is used to formalize
