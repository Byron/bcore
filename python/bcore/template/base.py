...
class ValidatedElementNodeBase(ElementNode):
    ...
    @snippet bcore/tests/template/test_base.py verified_element_node
    
    Whereas the usage of your instance could look like that:
    @snippet bcore/tests/template/test_base.py verified_element_node_usage
    ...
    @snippet bcore/tests/template/test_inference.py name-handling-extension
    """
