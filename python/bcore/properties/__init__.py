...
which in turn return instance of type [PropertyBase](@ref bcore.core.properties.base.PropertyBase). The latter
...
+ **Components Summary**
 - **Descriptors**
  - \ref bcore.core.properties.base.PropertyDescriptor "PropertyDescriptor"
   - A basic property with meta-data support
  - \ref bcore.core.properties.base.CompoundPropertyDescriptor "CompoundPropertyDescriptor"
   - A Descriptor that can contain other descriptors, useful for nesting of properties
 - **Properties**
  + \ref bcore.core.properties.base.PropertyBase "PropertyBase"
  ...
  + \ref bcore.core.properties.base.CompoundProperty "CompoundProperty"
   - Utility returned by CompoundPropertyDescriptor to return child properties accordingly
 - **Meta Classes**
  + \ref bcore.core.properties.base.PropertyMeta "PropertyMeta"
   - Basic meta-class to auto-name PropertyDescriptor instances based on their field in the class dict
  + \ref bcore.core.properties.base.PropertySchemaMeta "PropertySchemaMeta"
...
In the first example, a \ref bcore.core.properties.types.PrefixProperty "PrefixProperty" is used to formalize
