...
# test from x import *
from bcore.template import ElementNodeTree
from bcore.template.generators import *
from bcore.tests.template.base import TestTemplateBase
from bcore.utility import DictObject


class TestGenerators(TestTemplateBase):
    __slots__ = ()
    ...
    def test_formatting(self):
        ...
        assert len(list(string_tree)) == len(list(tree)), "default iteration should be the same for both implementations"
