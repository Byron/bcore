...
class TestTemplateBase(TestCaseBase):
    __slots__ = ()
    ...
    def fixture_path(cls, name):
        """@return fixture path instance pointing to a fixture with the given name"""
        return super(TestTemplateBase, cls).fixture_path(Path('core') / 'template' / name)
