...
class ICommand(bcore.InterfaceBase):
    ...
    def setup_argparser(self, argparser):
        ...
        @param argparser bcore.cmd.argparse.ArgumentParser compatible instance which is to be configured
        @return self
